...
export function MainContent() {
  const { currentExam, currentExamInfo } = useExamStore();
  const { sidebarCollapsed, sidebarVisible } = useSettingsStore();
  ...
  return (
    <div className="flex-1 flex">
      ...
      <div className={cn(
        ...
        currentExam && sidebarVisible && !sidebarCollapsed ? "mr-64 sm:mr-72 lg:mr-80 xl:mr-84" : 
        currentExam && sidebarVisible && sidebarCollapsed ? "mr-16" : ""
      )}>
      ...
      {currentExam && !sidebarVisible && (
        <button
          ...
          className="fixed right-4 top-1/2 -translate-y-1/2 z-40 bg-primary text-primary-foreground hover:bg-primary/90 rounded-l-lg p-2 shadow-lg transition-all duration-200"
          title="Show sidebar"
        >
